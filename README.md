...
// *Edit il 19/04/2021: Ho implementato il gioco degli scacchi con quasi tutte le sue funzionalità nei giorni seguenti alla pubblicazione di questo progetto. Pertanto oggi, 19/04/2021 ho pubblicato i nuovi file "server1.js" e "index1.js" che sono sostitutivi rispettivamente dei file "server.js" e "index.js". I vecchi file li ho comunque lasciati pubblicati. I nuovi file caricati non modificano la parte riguardante i servizi REST o Web-socket(quindi sono ininfluenti ai fini dell'esame di reti di calcolatori), ma rendono quello che prima era solo un "esempio di gioco", un gioco vero e proprio(che termina o con scacco matto o con stallo) e quindi rendono il progetto stesso "funzionale"* //
